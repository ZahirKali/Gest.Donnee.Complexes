...
public class Neo4jUtils {
        ...
        private static final String DB_PATH = "/home/sosso/GIT/Gest.Donnee.Complexes/src/neo4j/model";
        private long NodeId;
        ...
        public Neo4jUtils(){
        	neo4jModel = ModelFactory.createDefaultModel();
        	createNode();
        	ToModel();
        }
  
        public Model getNeo4jModel(){
        	return neo4jModel;
        }
     ...
     */
         ...
         */
        public void ToModel() { 
                String NS ="http://www.taxe-foncier.com#";
                neo4jModel.setNsPrefix("taxe", NS);
                
                Property Name = neo4jModel.createProperty(NS+"Name");
                Property Base = neo4jModel.createProperty(NS+"Basenette");
                Property Taux = neo4jModel.createProperty(NS+"Taux");
                ...
                for (Path friendPath : friendsTraverser) {
                		...
                		Resource region = neo4jModel.createResource(NS+friendPath.endNode().getProperty("name"));
                		Literal regionName = neo4jModel.createLiteral(friendPath.endNode().getProperty("name").toString());
                		Literal BaseNetteRegion = neo4jModel.createLiteral(friendPath.endNode().getProperty("Basenette").toString());
                		Literal TauxRegion = neo4jModel.createLiteral(friendPath.endNode().getProperty("taux").toString());
                        
                        region.addProperty(Name, regionName);
                        region.addProperty(Base, BaseNetteRegion);
                        region.addProperty(Taux, TauxRegion);
                 }
                
                try {       
                        FileOutputStream outStream = new FileOutputStream("/home/sosso/GIT/Gest.Donnee.Complexes/src/neo4j/model/Neo4jToRdf.rdf");
                        neo4jModel.write(outStream, "RDF/XML");
                        outStream.close();
                  }
        ...
        public void ToConsole(){
        	neo4jModel.write(System.out, "RDF/XML");
        }
        
        public void runQuery(String query){
  		   Query q = QueryFactory.create(query) ;
 		    QueryExecution qexec = QueryExecutionFactory.create(query, neo4jModel) ;
