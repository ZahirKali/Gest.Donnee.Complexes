...
Welcome to Neo4j release 1.9.5, a high-performance graph database.
...
* [Getting Started](http://docs.neo4j.org/chunked/1.9.5/introduction.html)
* [The Neo4j Manual (online)](http://docs.neo4j.org/chunked/1.9.5/)
